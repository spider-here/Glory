                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text("$_dummyRating / 5", style: TextStyle(
                                  fontSize: 14.0, color: Colors.white),),
                            ],
                          ),
                          Padding(
                            padding: const EdgeInsets.only(left: 25.0, right: 25.0, top: 20.0, bottom: 20.0),
                            child: Text(_dummyDescription, style: TextStyle(
                                fontSize: 14.0, color: Colors.grey,),),
                          ),
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Expanded(
                                  child: ElevatedButton.icon(onPressed: (){}, label: Text("Preview"), icon: Icon(Icons.read_more_rounded),
                                  style: ButtonStyle(
                                ...
                                Padding(padding: const EdgeInsets.only(right: 10.0)),
                                Expanded(
                                  child: ElevatedButton.icon(onPressed: (){}, label: Text("Reviews"), icon: Icon(Icons.comment_outlined,),
                                    style: ButtonStyle(
                                        backgroundColor: MaterialStateProperty.all(Colors.white),
                                        foregroundColor: MaterialStateProperty.all(Colors.black)
                                    ),),
